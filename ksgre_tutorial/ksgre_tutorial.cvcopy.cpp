 ...
 * these variables.
 *
 * Generated on Fri Jun 28 13:30:57 2019 
 */

#ifndef h_ksgre_tutorial_cvcopy_cpp
#define h_ksgre_tutorial_cvcopy_cpp

#include "cvcopy_proto.h"

#if defined(PSD_HW) && defined(HOST_TGT)
/* Include endian converter functions */
#include "ksgre_tutorial.cnvendian.globalvar.h"
#include "ksgre_tutorial.cnvendian.c"
...
static const cvcopy_table_entry cvcopy_table[] = {
    ...
    { &ksgre_gscalerfexc, sizeof(ksgre_gscalerfexc) },
    { &ksgre_spoilerarea, sizeof(ksgre_spoilerarea) },
    { &ksgre_ssi_time, sizeof(ksgre_ssi_time) },
    { &ksgre_dda, sizeof(ksgre_dda) },
    { &ksgre_spoilreadarea, sizeof(ksgre_spoilreadarea) },
...
void cvcopy_cnv_endian( char * data )
{
    ...
    cv_cnv_endian_ksgre_gscalerfexc( data );
    data += sizeof(ksgre_gscalerfexc);

    cv_cnv_endian_ksgre_spoilerarea( data );
    data += sizeof(ksgre_spoilerarea);

    cv_cnv_endian_ksgre_ssi_time( data );
    data += sizeof(ksgre_ssi_time);

    cv_cnv_endian_ksgre_dda( data );
    data += sizeof(ksgre_dda);

    cv_cnv_endian_ksgre_spoilreadarea( data );
    data += sizeof(ksgre_spoilreadarea);
...
#endif /* h_ksgre_tutorial_cvcopy_cpp */
