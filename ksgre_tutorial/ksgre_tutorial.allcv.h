...
#ifndef h_ksgre_tutorial_allcv_h
#define h_ksgre_tutorial_allcv_h
...
int ksgre_ssi_time = KSGRE_DEFAULT_SSI_TIME ;
int ksgre_dda = 2 ;
...
#endif /* h_ksgre_tutorial_allcv_h */
