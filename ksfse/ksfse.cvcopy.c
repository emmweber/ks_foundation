 ...
 * ksfse.cvcopy.c 
 *
 * This file is automatically generated by the '/ESE_DV26.0_R02/psd/bin/contigCVs' script.
 ...
 * these variables.
 *
 * Generated on Mon Apr 22 15:38:38 2019 
 */

#ifndef h_ksfse_cvcopy_c
#define h_ksfse_cvcopy_c

#include "cvcopy_proto.h"

#if defined(PSD_HW) && defined(HOST_TGT)
/* Include endian converter functions */
#include "ksfse.cnvendian.globalvar.h"
#include "ksfse.cnvendian.c"
...
static const cvcopy_table_entry cvcopy_table[] = {
    ...
    { &ia_rfbdtg_theta, sizeof(ia_rfbdtg_theta) },
    ...
    { &ia_rfbrs_theta, sizeof(ia_rfbrs_theta) },
    ...
    { &ksfse_excthickness, sizeof(ksfse_excthickness) },
    { &ksfse_gscalerfexc, sizeof(ksfse_gscalerfexc) },
    { &ksfse_flipexc, sizeof(ksfse_flipexc) },
    { &ksfse_spoilerarea, sizeof(ksfse_spoilerarea) },
    { &rf_stretch_rfexc, sizeof(rf_stretch_rfexc) },
    { &ksfse_inflowsuppression, sizeof(ksfse_inflowsuppression) },
    { &ksfse_inflowsuppression_mm, sizeof(ksfse_inflowsuppression_mm) },
    { &ksfse_vfa, sizeof(ksfse_vfa) },
    { &ksfse_crusherscale, sizeof(ksfse_crusherscale) },
    { &ksfse_gscalerfref, sizeof(ksfse_gscalerfref) },
    { &ksfse_slicecheck, sizeof(ksfse_slicecheck) },
    { &rf_stretch_rfref, sizeof(rf_stretch_rfref) },
    { &rf_stretch_all, sizeof(rf_stretch_all) },
    { &ksfse_recovery, sizeof(ksfse_recovery) },
    { &rf_stretch_rfrecovery, sizeof(rf_stretch_rfrecovery) },
    { &ksfse_kxnover_min, sizeof(ksfse_kxnover_min) },
    { &ksfse_kxnover, sizeof(ksfse_kxnover) },
    { &ksfse_rampsampling, sizeof(ksfse_rampsampling) },
    { &ksfse_extragap, sizeof(ksfse_extragap) },
    { &ksfse_etlte, sizeof(ksfse_etlte) },
    { &ksfse_xcrusherarea, sizeof(ksfse_xcrusherarea) },
    { &ksfse_esp, sizeof(ksfse_esp) },
    { &ksfse_noph, sizeof(ksfse_noph) },
    { &ksfse_minacslines, sizeof(ksfse_minacslines) },
    { &ksfse_minzacslines, sizeof(ksfse_minzacslines) },
    { &ksfse_pos_start, sizeof(ksfse_pos_start) },
    { &ksfse_ssi_time, sizeof(ksfse_ssi_time) },
    { &ksfse_dda, sizeof(ksfse_dda) },
    { &ksfse_debug, sizeof(ksfse_debug) },
    { &ksfse_imsize, sizeof(ksfse_imsize) },
    { &ksfse_abort_on_kserror, sizeof(ksfse_abort_on_kserror) },
    { &ksfse_mintr, sizeof(ksfse_mintr) },
    { &ksfse_maxtr, sizeof(ksfse_maxtr) },
...
void cvcopy_cnv_endian( char * data )
{
    ...
    cv_cnv_endian_ia_rfbdtg_theta( data );
    data += sizeof(ia_rfbdtg_theta);
    ...
    cv_cnv_endian_ia_rfbrs_theta( data );
    data += sizeof(ia_rfbrs_theta);
    ...
    cv_cnv_endian_ksfse_excthickness( data );
    data += sizeof(ksfse_excthickness);

    cv_cnv_endian_ksfse_gscalerfexc( data );
    data += sizeof(ksfse_gscalerfexc);

    cv_cnv_endian_ksfse_flipexc( data );
    data += sizeof(ksfse_flipexc);

    cv_cnv_endian_ksfse_spoilerarea( data );
    data += sizeof(ksfse_spoilerarea);

    cv_cnv_endian_rf_stretch_rfexc( data );
    data += sizeof(rf_stretch_rfexc);

    cv_cnv_endian_ksfse_inflowsuppression( data );
    data += sizeof(ksfse_inflowsuppression);

    cv_cnv_endian_ksfse_inflowsuppression_mm( data );
    data += sizeof(ksfse_inflowsuppression_mm);

    cv_cnv_endian_ksfse_vfa( data );
    data += sizeof(ksfse_vfa);

    cv_cnv_endian_ksfse_crusherscale( data );
    data += sizeof(ksfse_crusherscale);

    cv_cnv_endian_ksfse_gscalerfref( data );
    data += sizeof(ksfse_gscalerfref);

    cv_cnv_endian_ksfse_slicecheck( data );
    data += sizeof(ksfse_slicecheck);

    cv_cnv_endian_rf_stretch_rfref( data );
    data += sizeof(rf_stretch_rfref);

    cv_cnv_endian_rf_stretch_all( data );
    data += sizeof(rf_stretch_all);

    cv_cnv_endian_ksfse_recovery( data );
    data += sizeof(ksfse_recovery);

    cv_cnv_endian_rf_stretch_rfrecovery( data );
    data += sizeof(rf_stretch_rfrecovery);

    cv_cnv_endian_ksfse_kxnover_min( data );
    data += sizeof(ksfse_kxnover_min);

    cv_cnv_endian_ksfse_kxnover( data );
    data += sizeof(ksfse_kxnover);

    cv_cnv_endian_ksfse_rampsampling( data );
    data += sizeof(ksfse_rampsampling);

    cv_cnv_endian_ksfse_extragap( data );
    data += sizeof(ksfse_extragap);

    cv_cnv_endian_ksfse_etlte( data );
    data += sizeof(ksfse_etlte);

    cv_cnv_endian_ksfse_xcrusherarea( data );
    data += sizeof(ksfse_xcrusherarea);

    cv_cnv_endian_ksfse_esp( data );
    data += sizeof(ksfse_esp);

    cv_cnv_endian_ksfse_noph( data );
    data += sizeof(ksfse_noph);

    cv_cnv_endian_ksfse_minacslines( data );
    data += sizeof(ksfse_minacslines);

    cv_cnv_endian_ksfse_minzacslines( data );
    data += sizeof(ksfse_minzacslines);

    cv_cnv_endian_ksfse_pos_start( data );
    data += sizeof(ksfse_pos_start);

    cv_cnv_endian_ksfse_ssi_time( data );
    data += sizeof(ksfse_ssi_time);

    cv_cnv_endian_ksfse_dda( data );
    data += sizeof(ksfse_dda);

    cv_cnv_endian_ksfse_debug( data );
    data += sizeof(ksfse_debug);

    cv_cnv_endian_ksfse_imsize( data );
    data += sizeof(ksfse_imsize);

    cv_cnv_endian_ksfse_abort_on_kserror( data );
    data += sizeof(ksfse_abort_on_kserror);

    cv_cnv_endian_ksfse_mintr( data );
    data += sizeof(ksfse_mintr);

    cv_cnv_endian_ksfse_maxtr( data );
    data += sizeof(ksfse_maxtr);
