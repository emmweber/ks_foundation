...
cv_cnv_endian_struct_CTTEntry( struct CTTEntry *_ecnv_target_ )
{
	...
	cv_cnv_endian_s32( &_ecnv_target_->coilConnector );
...
cv_cnv_endian_struct__psd_coil_info_( struct _psd_coil_info_ *_ecnv_target_ )
{
	...
	{
		size_t _i27_0;
		for( _i27_0 = 0; _i27_0 < (5); ++_i27_0 ) {
			cv_cnv_endian_TX_COIL_INFO( &_ecnv_target_->txCoilInfo[_i27_0] );
		}
	}
...
cv_cnv_endian_SCAN_INFO( SCAN_INFO *_ecnv_target_ ) {
	...
	{
		size_t _i28_0;
		for( _i28_0 = 0; _i28_0 < (9); ++_i28_0 ) {
			cv_cnv_endian_float( &_ecnv_target_->oprot[_i28_0] );
		}
	}
}
...
cv_cnv_endian_PSC_INFO( PSC_INFO *_ecnv_target_ ) {
	...
	{
		size_t _i29_0;
		for( _i29_0 = 0; _i29_0 < (9); ++_i29_0 ) {
			cv_cnv_endian_float( &_ecnv_target_->oppscrot[_i29_0] );
		}
	}
...
cv_cnv_endian___fsid_t( __fsid_t *_ecnv_target_ ) {
	{
		size_t _i30_0;
		for( _i30_0 = 0; _i30_0 < (2); ++_i30_0 ) {
			cv_cnv_endian_int( &_ecnv_target_->__val[_i30_0] );
		}
	}
}
...
cv_cnv_endian_struct__IO_FILE( struct _IO_FILE *_ecnv_target_ )
{
	...
	{
		size_t _i31_0;
		for( _i31_0 = 0; _i31_0 < (1); ++_i31_0 ) {
			cv_cnv_endian_char( &_ecnv_target_->_shortbuf[_i31_0] );
		}
	}
	...
	{
		size_t _i32_0;
		for( _i32_0 = 0; _i32_0 < (15 * sizeof (int) - 4 * sizeof (void *) - sizeof (size_t)); ++_i32_0 ) {
			cv_cnv_endian_char( &_ecnv_target_->_unused2[_i32_0] );
		}
	}
}
...
cv_cnv_endian_HOEC_CAL_INFO( HOEC_CAL_INFO *_ecnv_target_ ) {
	...
	{
		size_t _i33_0, _i33_1;
		for( _i33_0 = 0; _i33_0 < (3); ++_i33_0 )
		for( _i33_1 = 0; _i33_1 < (56); ++_i33_1 ) {
			cv_cnv_endian_int( &_ecnv_target_->num_terms[_i33_0][_i33_1] );
		}
	}
	{
		size_t _i34_0, _i34_1, _i34_2;
		for( _i34_0 = 0; _i34_0 < (3); ++_i34_0 )
		for( _i34_1 = 0; _i34_1 < (56); ++_i34_1 )
		for( _i34_2 = 0; _i34_2 < (6); ++_i34_2 ) {
			cv_cnv_endian_float( &_ecnv_target_->alpha[_i34_0][_i34_1][_i34_2] );
		}
	}
	{
		size_t _i35_0, _i35_1, _i35_2;
		for( _i35_0 = 0; _i35_0 < (3); ++_i35_0 )
		for( _i35_1 = 0; _i35_1 < (56); ++_i35_1 )
		for( _i35_2 = 0; _i35_2 < (6); ++_i35_2 ) {
			cv_cnv_endian_float( &_ecnv_target_->tau[_i35_0][_i35_1][_i35_2] );
		}
	}
	{
		size_t _i36_0, _i36_1;
		for( _i36_0 = 0; _i36_0 < (3); ++_i36_0 )
		for( _i36_1 = 0; _i36_1 < (56); ++_i36_1 ) {
			cv_cnv_endian_int( &_ecnv_target_->termIndex2xyzOrderMapping[_i36_0][_i36_1] );
		}
	}
	{
		size_t _i37_0, _i37_1, _i37_2;
		for( _i37_0 = 0; _i37_0 < (6); ++_i37_0 )
		for( _i37_1 = 0; _i37_1 < (6); ++_i37_1 )
		for( _i37_2 = 0; _i37_2 < (6); ++_i37_2 ) {
			cv_cnv_endian_int( &_ecnv_target_->xyzOrder2termIndexMapping[_i37_0][_i37_1][_i37_2] );
		}
	}
}
...
cv_cnv_endian_RDB_HOEC_BASES_TYPE( RDB_HOEC_BASES_TYPE *_ecnv_target_ ) {
	{
		size_t _i38_0, _i38_1;
		for( _i38_0 = 0; _i38_0 < (56); ++_i38_0 )
		for( _i38_1 = 0; _i38_1 < (3); ++_i38_1 ) {
			cv_cnv_endian_float( &_ecnv_target_->hoec_coef[_i38_0][_i38_1] );
		}
	}
	{
		size_t _i39_0;
		for( _i39_0 = 0; _i39_0 < (56); ++_i39_0 ) {
			cv_cnv_endian_int( &_ecnv_target_->hoec_xorder[_i39_0] );
		}
	}
	{
		size_t _i40_0;
		for( _i40_0 = 0; _i40_0 < (56); ++_i40_0 ) {
			cv_cnv_endian_int( &_ecnv_target_->hoec_yorder[_i40_0] );
		}
	}
	{
		size_t _i41_0;
		for( _i41_0 = 0; _i41_0 < (56); ++_i41_0 ) {
			cv_cnv_endian_int( &_ecnv_target_->hoec_zorder[_i41_0] );
		}
	}
}
...
cv_cnv_endian_struct___locale_struct( struct __locale_struct *_ecnv_target_ )
{
	{
		size_t _i42_0;
		for( _i42_0 = 0; _i42_0 < (13); ++_i42_0 ) {
			cv_cnv_endian_unsigned_long( &_ecnv_target_->__locales[_i42_0] );
		}
	}
	...
	{
		size_t _i43_0;
		for( _i43_0 = 0; _i43_0 < (13); ++_i43_0 ) {
			cv_cnv_endian_unsigned_long( &_ecnv_target_->__names[_i43_0] );
		}
	}
}
...
cv_cnv_endian_DbKey( DbKey *_ecnv_target_ ) {
	{
		size_t _i44_0;
		for( _i44_0 = 0; _i44_0 < (4); ++_i44_0 ) {
			cv_cnv_endian_char( &_ecnv_target_->su_id[_i44_0] );
		}
	}
...
cv_cnv_endian_OP_NMRID_TYPE( OP_NMRID_TYPE *_ecnv_target_ ) {
	{
		size_t _i45_0;
		for( _i45_0 = 0; _i45_0 < (12); ++_i45_0 ) {
			cv_cnv_endian_char( (char *)&((*_ecnv_target_)[_i45_0]) );
		}
	}
}
...
cv_cnv_endian_OP_RECN_STOP_TYPE( OP_RECN_STOP_TYPE *_ecnv_target_ ) {
	...
	{
		size_t _i46_0;
		for( _i46_0 = 0; _i46_0 < (12); ++_i46_0 ) {
			cv_cnv_endian_char( &_ecnv_target_->scan_initiator[_i46_0] );
		}
	}
}
...
cv_cnv_endian_OP_VIEWTABLE_UPDATE_TYPE( OP_VIEWTABLE_UPDATE_TYPE *_ecnv_target_ ) {
	...
	{
		size_t _i47_0;
		for( _i47_0 = 0; _i47_0 < (256); ++_i47_0 ) {
			cv_cnv_endian_s32( &_ecnv_target_->table[_i47_0] );
		}
	}
}
...
cv_cnv_endian_PSD_EXIT_ARG( PSD_EXIT_ARG *_ecnv_target_ ) {
	...
	{
		size_t _i48_0;
		for( _i48_0 = 0; _i48_0 < (256); ++_i48_0 ) {
			cv_cnv_endian_char( &_ecnv_target_->text_string[_i48_0] );
		}
	}
	{
		size_t _i49_0;
		for( _i49_0 = 0; _i49_0 < (16); ++_i49_0 ) {
			cv_cnv_endian_char( &_ecnv_target_->text_arg[_i49_0] );
		}
	}
	{
		size_t _i50_0;
		for( _i50_0 = 0; _i50_0 < (4); ++_i50_0 ) {
			cv_cnv_endian_unsigned_long( &_ecnv_target_->longarg[_i50_0] );
		}
	}
}
...
cv_cnv_endian_EXTERN_FILENAME( EXTERN_FILENAME *_ecnv_target_ ) {
	{
		size_t _i51_0;
		for( _i51_0 = 0; _i51_0 < (80); ++_i51_0 ) {
			cv_cnv_endian_char( (char *)&((*_ecnv_target_)[_i51_0]) );
		}
	}
}
...
cv_cnv_endian_entry_point_table_t( entry_point_table_t *_ecnv_target_ ) {
	{
		size_t _i52_0;
		for( _i52_0 = 0; _i52_0 < (16); ++_i52_0 ) {
			cv_cnv_endian_char( &_ecnv_target_->epname[_i52_0] );
		}
	}
...
cv_cnv_endian_RSP_PSC_INFO( RSP_PSC_INFO *_ecnv_target_ ) {
	...
	{
		size_t _i53_0;
		for( _i53_0 = 0; _i53_0 < (10); ++_i53_0 ) {
			cv_cnv_endian_long( &_ecnv_target_->rsppscrot[_i53_0] );
		}
	}
...
cv_cnv_endian_GIR_INFO( GIR_INFO *_ecnv_target_ ) {
	...
	{
		size_t _i54_0;
		for( _i54_0 = 0; _i54_0 < (9); ++_i54_0 ) {
			cv_cnv_endian_float( &_ecnv_target_->opgirrot[_i54_0] );
		}
	}
}
...
cv_cnv_endian___sigset_t( __sigset_t *_ecnv_target_ ) {
	{
		size_t _i55_0;
		for( _i55_0 = 0; _i55_0 < ((1024 / (8 * sizeof (unsigned long int)))); ++_i55_0 ) {
			cv_cnv_endian_unsigned_long( &_ecnv_target_->__val[_i55_0] );
		}
	}
}
...
cv_cnv_endian_fd_set( fd_set *_ecnv_target_ ) {
	{
		size_t _i56_0;
		for( _i56_0 = 0; _i56_0 < (1024 / (8 * (int) sizeof (__fd_mask))); ++_i56_0 ) {
			cv_cnv_endian___fd_mask( &_ecnv_target_->__fds_bits[_i56_0] );
		}
	}
}
...
cv_cnv_endian_struct_drand48_data( struct drand48_data *_ecnv_target_ )
{
	{
		size_t _i57_0;
		for( _i57_0 = 0; _i57_0 < (3); ++_i57_0 ) {
			cv_cnv_endian_unsigned_short( &_ecnv_target_->__x[_i57_0] );
		}
	}
	{
		size_t _i58_0;
		for( _i58_0 = 0; _i58_0 < (3); ++_i58_0 ) {
			cv_cnv_endian_unsigned_short( &_ecnv_target_->__old_x[_i58_0] );
		}
	}
...
cv_cnv_endian_SEQUENCE_ENTRIES( SEQUENCE_ENTRIES *_ecnv_target_ ) {
	{
		size_t _i59_0;
		for( _i59_0 = 0; _i59_0 < (9); ++_i59_0 ) {
			cv_cnv_endian_long( (long *)&((*_ecnv_target_)[_i59_0]) );
		}
	}
}
...
cv_cnv_endian_struct_psdiopt_s( struct psdiopt_s *_ecnv_target_ )
{
	...
	{
		size_t _i60_0;
		for( _i60_0 = 0; _i60_0 < (8192); ++_i60_0 ) {
			cv_cnv_endian_char( &_ecnv_target_->iopt_name[_i60_0] );
		}
	}
...
cv_cnv_endian_KS_DESCRIPTION( KS_DESCRIPTION *_ecnv_target_ ) {
	{
		size_t _i61_0;
		for( _i61_0 = 0; _i61_0 < (128); ++_i61_0 ) {
			cv_cnv_endian_char( (char *)&((*_ecnv_target_)[_i61_0]) );
		}
	}
}
...
cv_cnv_endian_KS_WAVEFORM( KS_WAVEFORM *_ecnv_target_ ) {
	{
		size_t _i62_0;
		for( _i62_0 = 0; _i62_0 < (10000); ++_i62_0 ) {
			cv_cnv_endian_float( (float *)&((*_ecnv_target_)[_i62_0]) );
		}
	}
}
...
cv_cnv_endian_KS_IWAVE( KS_IWAVE *_ecnv_target_ ) {
	{
		size_t _i63_0;
		for( _i63_0 = 0; _i63_0 < (10000); ++_i63_0 ) {
			cv_cnv_endian_short( (short *)&((*_ecnv_target_)[_i63_0]) );
		}
	}
}
...
cv_cnv_endian_KS_MAT3x3( KS_MAT3x3 *_ecnv_target_ ) {
	{
		size_t _i64_0;
		for( _i64_0 = 0; _i64_0 < (9); ++_i64_0 ) {
			cv_cnv_endian_double( (double *)&((*_ecnv_target_)[_i64_0]) );
		}
	}
}
...
cv_cnv_endian_KS_MAT4x4( KS_MAT4x4 *_ecnv_target_ ) {
	{
		size_t _i65_0;
		for( _i65_0 = 0; _i65_0 < (16); ++_i65_0 ) {
			cv_cnv_endian_double( (double *)&((*_ecnv_target_)[_i65_0]) );
		}
	}
}
...
cv_cnv_endian_struct__wait_s( struct _wait_s *_ecnv_target_ )
{
	...
	{
		size_t _i66_0;
		for( _i66_0 = 0; _i66_0 < (500); ++_i66_0 ) {
			cv_cnv_endian_KS_SEQLOC( &_ecnv_target_->locs[_i66_0] );
		}
	}
...
cv_cnv_endian_struct__trap_s( struct _trap_s *_ecnv_target_ )
{
	...
	cv_cnv_endian_int( &_ecnv_target_->duration );
	{
		...
		for( _i67_0 = 0; _i67_0 < (3); ++_i67_0 ) {
			cv_cnv_endian_int( &_ecnv_target_->gradnum[_i67_0] );
		}
	}
	{
		size_t _i68_0;
		for( _i68_0 = 0; _i68_0 < (500); ++_i68_0 ) {
			cv_cnv_endian_KS_SEQLOC( &_ecnv_target_->locs[_i68_0] );
		}
	}
	cv_cnv_endian_unsigned_long( &_ecnv_target_->wfpulse );
	cv_cnv_endian_unsigned_long( &_ecnv_target_->wfi );
...
cv_cnv_endian_KS_WAVE( KS_WAVE *_ecnv_target_ ) {
	...
	{
		size_t _i69_0;
		for( _i69_0 = 0; _i69_0 < (3); ++_i69_0 ) {
			cv_cnv_endian_int( &_ecnv_target_->gradnum[_i69_0] );
		}
	}
	cv_cnv_endian_int( &_ecnv_target_->gradwave_units );
	{
		size_t _i70_0;
		for( _i70_0 = 0; _i70_0 < (500); ++_i70_0 ) {
			cv_cnv_endian_KS_SEQLOC( &_ecnv_target_->locs[_i70_0] );
		}
	}
	cv_cnv_endian_unsigned_long( &_ecnv_target_->wfpulse );
	cv_cnv_endian_unsigned_long( &_ecnv_target_->wfi );
...
cv_cnv_endian_struct__acq_s( struct _acq_s *_ecnv_target_ )
{
	...
	{
		size_t _i71_0;
		for( _i71_0 = 0; _i71_0 < (500); ++_i71_0 ) {
			cv_cnv_endian_int( &_ecnv_target_->pos[_i71_0] );
		}
	}
...
cv_cnv_endian_struct__gradrfctrl_s( struct _gradrfctrl_s *_ecnv_target_ )
{
	{
		size_t _i72_0;
		for( _i72_0 = 0; _i72_0 < (20); ++_i72_0 ) {
			cv_cnv_endian_unsigned_long( &_ecnv_target_->rfptr[_i72_0] );
		}
	}
	cv_cnv_endian_int( &_ecnv_target_->numrf );
	{
		size_t _i73_0;
		for( _i73_0 = 0; _i73_0 < (200); ++_i73_0 ) {
			cv_cnv_endian_unsigned_long( &_ecnv_target_->trapptr[_i73_0] );
		}
	}
	cv_cnv_endian_int( &_ecnv_target_->numtrap );
	{
		size_t _i74_0;
		for( _i74_0 = 0; _i74_0 < (200); ++_i74_0 ) {
			cv_cnv_endian_unsigned_long( &_ecnv_target_->waveptr[_i74_0] );
		}
	}
	cv_cnv_endian_int( &_ecnv_target_->numwave );
	{
		size_t _i75_0;
		for( _i75_0 = 0; _i75_0 < (500); ++_i75_0 ) {
			cv_cnv_endian_unsigned_long( &_ecnv_target_->readptr[_i75_0] );
		}
	}
...
cv_cnv_endian_struct__seq_collection_s( struct _seq_collection_s *_ecnv_target_ )
{
	...
	{
		size_t _i76_0;
		for( _i76_0 = 0; _i76_0 < (200); ++_i76_0 ) {
			cv_cnv_endian_unsigned_long( &_ecnv_target_->seqctrlptr[_i76_0] );
		}
	}
}
...
cv_cnv_endian_struct__KS_SLICE_PLAN( struct _KS_SLICE_PLAN *_ecnv_target_ )
{
	...
	{
		size_t _i77_0;
		for( _i77_0 = 0; _i77_0 < (1 * (2048)); ++_i77_0 ) {
			cv_cnv_endian_DATA_ACQ_ORDER( &_ecnv_target_->acq_order[_i77_0] );
		}
	}
}
...
{
	{
		...
		for( _i78_0 = 0; _i78_0 < (3); ++_i78_0 ) {
			cv_cnv_endian_KS_WAVE( &_ecnv_target_->grads[_i78_0] );
		}
	}
	...
	cv_cnv_endian_KS_READ( &_ecnv_target_->acq );
	{
		...
		for( _i79_0 = 0; _i79_0 < (3); ++_i79_0 ) {
			cv_cnv_endian_int( &_ecnv_target_->delay[_i79_0] );
		}
	}
	{
		size_t _i80_0;
		for( _i80_0 = 0; _i80_0 < (3); ++_i80_0 ) {
			cv_cnv_endian_float( &_ecnv_target_->amp[_i80_0] );
		}
	}
	cv_cnv_endian_float( &_ecnv_target_->freqoffHz );
	cv_cnv_endian_float( &_ecnv_target_->fov );
...
cv_cnv_endian_struct__phase_s( struct _phase_s *_ecnv_target_ )
{
	...
	{
		size_t _i81_0;
		for( _i81_0 = 0; _i81_0 < (1025); ++_i81_0 ) {
			cv_cnv_endian_int( &_ecnv_target_->linetoacq[_i81_0] );
		}
	}
}
...
cv_cnv_endian_struct__dixon_dualreadtrap_s( struct _dixon_dualreadtrap_s *_ecnv_target_ )
{
	...
	{
		size_t _i82_0;
		for( _i82_0 = 0; _i82_0 < (2); ++_i82_0 ) {
			cv_cnv_endian_int( &_ecnv_target_->shifts[_i82_0] );
		}
	}
	cv_cnv_endian_int( &_ecnv_target_->nover );
	cv_cnv_endian_float( &_ecnv_target_->area2center );
	...
	{
		size_t _i83_0;
		for( _i83_0 = 0; _i83_0 < (4); ++_i83_0 ) {
			cv_cnv_endian_int( &_ecnv_target_->rampsampling[_i83_0] );
		}
	}
}
...
void
cv_cnv_endian_struct_KSFSE_SEQUENCE( struct KSFSE_SEQUENCE *_ecnv_target_ )
{
	cv_cnv_endian_KS_SEQ_CONTROL( &_ecnv_target_->seqctrl );
	cv_cnv_endian_KS_READTRAP( &_ecnv_target_->read );
	cv_cnv_endian_KS_TRAP( &_ecnv_target_->readdephaser );
	cv_cnv_endian_KS_PHASER( &_ecnv_target_->phaseenc );
	cv_cnv_endian_KS_PHASER( &_ecnv_target_->zphaseenc );
	cv_cnv_endian_KS_TRAP( &_ecnv_target_->spoiler );
	cv_cnv_endian_KS_SELRF( &_ecnv_target_->selrfexc );
	cv_cnv_endian_KS_SELRF( &_ecnv_target_->selrfref1st );
	cv_cnv_endian_KS_SELRF( &_ecnv_target_->selrfref2nd );
	cv_cnv_endian_KS_SELRF( &_ecnv_target_->selrfref );
	cv_cnv_endian_KS_SELRF( &_ecnv_target_->selrfrecover );
	cv_cnv_endian_KS_SELRF( &_ecnv_target_->selrfrecoverref );
	cv_cnv_endian_KS_PHASEENCODING_PLAN( &_ecnv_target_->phaseenc_plan );
}

void
cv_cnv_endian_KSFSE_SEQUENCE( KSFSE_SEQUENCE *_ecnv_target_ ) {
	cv_cnv_endian_struct_KSFSE_SEQUENCE( (struct KSFSE_SEQUENCE *)_ecnv_target_ );
}
