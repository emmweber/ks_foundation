...
#ifndef h_ksfse_allcv_h
#define h_ksfse_allcv_h
...
* Readout(s)
*****************************************************************************************************/
int ksfse_kxnover_min = KSFSE_MINHNOVER ;
...
* Sequence general
*****************************************************************************************************/
int ksfse_pos_start = KS_RFSSP_PRETIME ;
int ksfse_ssi_time = KSFSE_MIN_SSI_TIME ;
int ksfse_dda = 2 ;
int ksfse_debug = 1 ;
int ksfse_imsize = KS_IMSIZE_MIN256 ;
int ksfse_abort_on_kserror = FALSE ;
int ksfse_mintr = 0 ;
int ksfse_maxtr = 0 ;
