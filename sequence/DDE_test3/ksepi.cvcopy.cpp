 ...
 * these variables.
 *
 * Generated on Tue Nov 19 17:29:46 2019 
 */
...
static const cvcopy_table_entry cvcopy_table[] = {
    ...
    { &opdde, sizeof(opdde) },
    { &num_oscillations, sizeof(num_oscillations) },
    { &opuser51, sizeof(opuser51) },
    ...
    { &diffscheme_2, sizeof(diffscheme_2) },
...
void cvcopy_cnv_endian( char * data )
{
    ...
    cv_cnv_endian_opdde( data );
    data += sizeof(opdde);

    cv_cnv_endian_num_oscillations( data );
    data += sizeof(num_oscillations);

    cv_cnv_endian_opuser51( data );
    data += sizeof(opuser51);
    ...
    cv_cnv_endian_diffscheme_2( data );
    data += sizeof(diffscheme_2);
