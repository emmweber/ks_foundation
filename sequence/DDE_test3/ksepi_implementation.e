...
/* emmweber  */
piuset |= use30;
cvmod(opuser30, 1500, 30000,2000, _ksepi_kz_nacslines.descr, 0, "Mixing time ");

piuset |= use31;
cvmod(opuser31, 0, 10, 0, _ksepi_kz_nacslines.descr, 0, "number of oscillations ");
/* --------------------------------------------------------------------------------------*/
...
STATUS ksepi_predownload_plot(KS_SEQ_COLLECTION* seqcollection) {
  ...
  ks_print_trap(ksepi.mytrap_1, fp); /* opdiffuse = 1 */
  ks_print_trap(ksepi.mytrap_2, fp); /* opdualspinecho = 1, opdiffuse = 1 */
