...
#ifndef h_ksepi_tgtdecl_h
#define h_ksepi_tgtdecl_h
...
#define seqFLEET_set
#else
#error KS_SEQLENGTH: Sequence name seqFLEET (arg 1) already taken
#endif
    SEQUENCE_ENTRIES  off_seqFLEET;
    WF_PULSE seqFLEET;
#if defined(HOST_TGT)
    int idx_seqFLEET;   /* sequence entry index */
#endif
  /*****************************************************************************************************
 * RSP Variables
 * Accessible for tgt.c (on TGT)
